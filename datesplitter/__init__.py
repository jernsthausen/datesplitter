...
#***************** OPTIONAL CONFIG ***************************************************
PARENT_LABEL  = 'DateString'               # the XML tag for each labeled string
GROUP_LABEL   = 'DateCollection'                  # the XML tag for a group of strings
...
def tag(raw_string) :
    ...
    if 'DateTime' in tagged:
        date_type='DateTime'
    else:
        date_type='DateOnly'

    return tagged, date_type #dialect
